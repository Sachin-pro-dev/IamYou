...
//       <div className="relative p-6 bg-black rounded-lg border border-gray-800 hover:border-purple-500 transition-all duration-300">
...
//         <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-900/20 via-black/30 to-black/50 animate-pulse-glow"></div>
//         <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMTAiIGN5PSIxMCIgcj0iMC41IiBmaWxsPSJyZ2JhKDk5LCAxMDIsIDI0MSwgMC4yKSIvPjwvc3ZnPg==')] opacity-20"></div>
//       </div>
...
//         {/* Vision Section */}
//         <section className="py-20 px-4 bg-gradient-to-b from-black/80 via-blue-900/10 to-black/80">
...
//             <div className="p-6 bg-purple-500/10 rounded-lg border border-purple-500/20 hover-lift card-glow backdrop-blur-sm">
...
//               <div className="p-6 bg-red-500/10 rounded-lg border border-red-500/20 hover-lift card-glow backdrop-blur-sm">
//                 <p className="text-lg text-gray-300 leading-relaxed">
...
//               <blockquote className="p-6 bg-gray-900/50 rounded-lg border-l-4 border-blue-500 hover-lift transform hover:scale-105 transition-all duration-300 backdrop-blur-sm">
...
//         {/* Demo Section */}
//         <section className="py-20 px-4 bg-gradient-to-b from-black/80 via-blue-900/20 to-black/80">
//           <div className="max-w-7xl mx-auto">

...
//       <ScrollArea className="flex-1 p-4 rounded-lg bg-secondary/50 mb-4">
...
//           className="flex-1 min-h-[44px] max-h-[200px] bg-secondary"
//           onKeyDown={(e) => {
...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col w-full max-w-4xl h-screen p-4 ">
      <div className="flex items-center justify-center mb-4 p-4">
        <Bot className="w-8 h-8 text-primary mr-2" />
        <h1 className="text-2xl font-bold text-primary p-0 m-0   ">Your Doppelganger</h1>
      </div>
